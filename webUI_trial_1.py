...
<head>
    ...
    <style>
        ...
        #save-anchors-btn { background-color: #007bff; color: white; border: none; padding: 10px 15px; border-radius: 5px; cursor: pointer; margin-top: 10px; transition: background-color 0.2s; }
        #save-anchors-btn:hover { background-color: #0056b3; }
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="info-section">
                ...
                <button id="save-area-btn">Save Area</button>
            </div>
            <div id="anchor-controls" class="anchor-controls">
                <h3>Anchor Positions (cm)</h3>
            </div>
            <button id="save-anchors-btn">Save Anchor Positions</button>
            ...
            <div class="tag-rename-controls">
                ...
                <button id="rename-tag-btn">Rename Tag</button>
            </div>
            <h2>Live Data</h2>
    ...
    <script>
        ...
        document.getElementById('rename-tag-btn').addEventListener('click', async () => {
            ...
            try {
                ...
                document.getElementById('old-tag-name').value = '';
        ...
        function updateMapDimensions(data) {
            ...
            // Always update the input fields to stay in sync
